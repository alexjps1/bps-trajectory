"""
Scene Reconstruction Visualization Script
...
def visualize_cloud_difference(
    ...
    ax.set_title(
        f"2D Predicted Cloud Error (Nearest Neighbor - Max Error: {colormap_max_err})"
    )
    ...
    sm = cm.ScalarMappable(
        cmap=cmap_custom, norm=colors.Normalize(vmin=0, vmax=colormap_max_err)
    )
